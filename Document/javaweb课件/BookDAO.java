package com.atguigu.javaweb.bookstore.dao;

import java.util.Collection;
import java.util.List;

import net.lampbrother.javaweb.bookstore.domain.Book;
import net.lampbrother.javaweb.bookstore.domain.ShoppingCartItem;
import net.lampbrother.javaweb.bookstore.utils.CriteriaBook;
import net.lampbrother.javaweb.bookstore.utils.Page;
